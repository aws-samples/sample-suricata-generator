...
> 💡 **TL;DR:** Install Python 3.6+ with tkinter, then run `python3 suricata_generator.py`. Per-OS commands are in the collapsible sections below.

### System Requirements

**Required:** Python 3.6+ and tkinter (GUI library)
**Optional:** wxPython (only for the [Advanced Editor](#advanced-editor-new-in-v1190-enhanced-in-v1230) with code folding)

### Step 1: Install Python

Check first: `python3 --version` (or `python --version`). Need 3.6 or higher. If you already have it, skip to Step 2.
...
- Check the Python version: `python3 --version` (must be 3.6+)
