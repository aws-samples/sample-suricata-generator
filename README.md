...
- [Managed Rule Group Generator - ⭐ New](#managed-rule-group-generator)
...
> ⭐ **NEW in v2.4.0** — Cherry-pick rules from AWS-managed threat signature rule groups and deploy filtered rule groups to AWS Network Firewall.
...
src/
  ...
  mrg/                         # Managed Rule Group Generator (NEW in v2.4.0)
