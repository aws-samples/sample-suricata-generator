...
### 🎯 Advanced Features
- [AI Rule Assistant](#ai-rule-assistant)
- [AI Rule Analysis](#ai-rule-analysis)
...
- [Container Association Manager](#container-association-manager-new-in-v280) ⭐ New!
...
- [Additional Local File Analysis](#additional-local-file-analysis)
...
- [Test Rules with PCAP](#test-rules-with-pcap)
...
> 💡 Reference and Container Association variables both use the `@` prefix. Use "Add Reference (@)" for managed prefix lists / static IP sets, and "Add Container Association (@)" for ECS/EKS container associations. See [Container Associations](#container-associations) for the exclusivity rule and the 5-vs-30 limit.
...
> 💡 **It's more than just a hit counter!** The analyzer provides health scoring, shadow rule detection, deployment-aware confidence levels, Pareto effectiveness analysis, capacity optimization recommendations, and category-based domain intelligence — all from your existing CloudWatch logs.

The CloudWatch Rule Usage Analyzer provides **ten analytical views**:
...
5. **Review Results**: Multi-tab results window with comprehensive analytics
...
## Change Tracking *(new in v1.16.0, enhanced with rollback in v1.25.0)*
