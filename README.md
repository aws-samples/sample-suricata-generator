...
- [Additional Local File Analysis - ⭐ New](#additional-local-file-analysis)
...
> ⭐ **NEW in v2.3.0** — AI-powered semantic analysis of your entire ruleset via Amazon Bedrock.
...
## Additional Local File Analysis

> ⭐ **NEW in v2.5.0** — Analyze multiple rule files together as a unified pool alongside AWS Managed Rule Groups!
